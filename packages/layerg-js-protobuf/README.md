LayerG JavaScript Protobuf adapter
========================

> Websocket adapter adding protocol buffer support to the [layerg-js](https://www.npmjs.com/package/@u2ulabs/layerg-js) client.
...
1. Import the adapter into your project:
    ...
    ```shell
    yarn add "@u2ulabs/layerg-js-protobuf"
    ```

2. Pass the Protobuf adapter to build the socket object.

    ```js
    import {Client} from "@u2ulabs/layerg-js";
    import {WebSocketAdapterPb} from "@u2ulabs/layerg-js-protobuf"
...
This project is licensed under the [Apache-2 License](https://github.com/u2ulabs/layerg-js/blob/master/LICENSE).
