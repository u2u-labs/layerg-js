...
* - telegram: Telegram
 ...
 - facebook: Facebook
*/
export declare enum UASocialLoginRequestSocialSource {
    telegram = 0,
    google = 1,
    twitter = 2,
    facebook = 3
...
/** Send a Evm token to the server. Used with authenticate/link/unlink. */
export interface ApiAccountEvm {
    evm_address?: string;
...
/** Send a Twitter token to the server. Used with authenticate/link/unlink. */
export interface ApiAccountTwitter {
    vars?: Record<string, string>;
}
...
/**  */
export interface ApiSendEmailOTPRequest {
    email?: string;
}
/**  */
export interface ApiSendTelegramOTPRequest {
    telegram_id?: string;
}
...
/**  */
export interface ApiUASocialLoginRequest {
    code?: string;
    source?: UASocialLoginRequestSocialSource;
    state?: string;
    vars?: Record<string, string>;
}
...
export declare class LayerGApi {
    ...
    sendEmailAuthOTP(bearerToken: string, body: ApiSendEmailOTPRequest, options?: any): Promise<any>;
    /** Request Telegram OTP for authentication. */
    sendTelegramAuthOTP(bearerToken: string, body: ApiSendTelegramOTPRequest, options?: any): Promise<any>;
    ...
    authenticateGoogle(basicAuthUsername: string, basicAuthPassword: string, account: ApiAccountGoogle, create?: boolean, username?: string, code?: string, state?: string, error?: string, options?: any): Promise<ApiSession>;
    ...
    authenticateTwitter(basicAuthUsername: string, basicAuthPassword: string, account: ApiAccountTwitter, create?: boolean, username?: string, code?: string, state?: string, error?: string, options?: any): Promise<ApiSession>;
    /**  */
    authenticateUA(basicAuthUsername: string, basicAuthPassword: string, body: ApiUASocialLoginRequest, options?: any): Promise<ApiSession>;
    ...
    linkEvm(bearerToken: string, body: ApiAccountEvm, options?: any): Promise<any>;
