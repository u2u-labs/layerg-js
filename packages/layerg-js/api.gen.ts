...
* - telegram: Telegram
 ...
 - facebook: Facebook
*/
export enum UASocialLoginRequestSocialSource
{
    /*  */
    telegram = 0,
    /*  */
...
export class LayerGApi {
  ...
  sendEmailAuthOTP(bearerToken: string,
      body:ApiSendEmailOTPRequest,
      options: any = {}): Promise<any> {
  ...
  sendTelegramAuthOTP(bearerToken: string,
      body:ApiSendTelegramOTPRequest,
      options: any = {}): Promise<any> {
  ...
  authenticateEvm(basicAuthUsername: string,
    basicAuthPassword: string,
      account:ApiAccountEvm,
      create?:boolean,
      options: any = {}): Promise<ApiSession> {
  ...
  authenticateTelegram(basicAuthUsername: string,
    basicAuthPassword: string,
      account:ApiAccountTelegram,
      create?:boolean,
      options: any = {}): Promise<ApiSession> {
  ...
  authenticateTwitter(basicAuthUsername: string,
    basicAuthPassword: string,
      account:ApiAccountTwitter,
      create?:boolean,
      username?:string,
      code?:string,
      state?:string,
  ...
  /**  */
  authenticateUA(basicAuthUsername: string,
    basicAuthPassword: string,
      body:ApiUASocialLoginRequest,
      options: any = {}): Promise<ApiSession> {
  ...
  getMatchmakerStats(bearerToken: string,
      options: any = {}): Promise<ApiMatchmakerStats> {
