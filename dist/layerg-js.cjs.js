...
// index.ts
var layerg_js_exports = {};
__export(layerg_js_exports, {
  Client: () => Client,
  DefaultSocket: () => DefaultSocket,
  Session: () => Session,
  WebSocketAdapterText: () => WebSocketAdapterText
});
module.exports = __toCommonJS(layerg_js_exports);
...
var WebSocketAdapterText = class {
  ...
  isOpen() {
    var _a;
    return !!this._socket && ((_a = this._socket) == null ? void 0 : _a.readyState) == WebSocket.OPEN;
  }
