(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.layergjs = {}));
  ...
  */
  ...
  var LayerGApi = /** @class */ (function () {
      function LayerGApi(serverKey, basePath, timeoutMs) {
          this.serverKey = serverKey;
          this.basePath = basePath;
          this.timeoutMs = timeoutMs;
      }
      /** A healthcheck which load balancers can use to check the service. */
      LayerGApi.prototype.healthcheck = function (bearerToken, options) {
          var _this = this;
      ...
      LayerGApi.prototype.deleteAccount = function (bearerToken, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.getAccount = function (bearerToken, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          var urlPath = "/v2/account";
          var queryParams = new Map();
      ...
      LayerGApi.prototype.updateAccount = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.authenticateApple = function (basicAuthUsername, basicAuthPassword, account, create, username, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.authenticateCustom = function (basicAuthUsername, basicAuthPassword, account, create, username, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.authenticateDevice = function (basicAuthUsername, basicAuthPassword, account, create, username, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.authenticateEmail = function (basicAuthUsername, basicAuthPassword, account, create, username, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.authenticateFacebook = function (basicAuthUsername, basicAuthPassword, account, create, username, sync, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.authenticateFacebookInstantGame = function (basicAuthUsername, basicAuthPassword, account, create, username, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.authenticateGameCenter = function (basicAuthUsername, basicAuthPassword, account, create, username, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.authenticateGoogle = function (basicAuthUsername, basicAuthPassword, account, create, username, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.authenticateSteam = function (basicAuthUsername, basicAuthPassword, account, create, username, sync, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      /** Authenticate a user with Google against the server. */
      LayerGApi.prototype.authenticateTelegram = function (basicAuthUsername, basicAuthPassword, account, create, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/account/authenticate/telegram";
          var queryParams = new Map();
          queryParams.set("create", create);
          var bodyJson = "";
          bodyJson = JSON.stringify(account || {});
      ...
      LayerGApi.prototype.linkApple = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.linkCustom = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.linkDevice = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.linkEmail = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.linkFacebook = function (bearerToken, account, sync, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.linkFacebookInstantGame = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.linkGameCenter = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.linkGoogle = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.linkSteam = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.sessionRefresh = function (basicAuthUsername, basicAuthPassword, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.unlinkApple = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.unlinkCustom = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.unlinkDevice = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.unlinkEmail = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.unlinkFacebook = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.unlinkFacebookInstantGame = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.unlinkGameCenter = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.unlinkGoogle = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.unlinkSteam = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listChannelMessages = function (bearerToken, channelId, limit, forward, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.event = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.deleteFriends = function (bearerToken, ids, usernames, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.listFriends = function (bearerToken, limit, state, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          var urlPath = "/v2/friend";
          var queryParams = new Map();
      ...
      LayerGApi.prototype.addFriends = function (bearerToken, ids, usernames, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          var urlPath = "/v2/friend";
          var queryParams = new Map();
      ...
      LayerGApi.prototype.blockFriends = function (bearerToken, ids, usernames, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.importFacebookFriends = function (bearerToken, account, reset, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listFriendsOfFriends = function (bearerToken, limit, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.importSteamFriends = function (bearerToken, account, reset, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (account === null || account === undefined) {
              throw new Error("'account' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listGroups = function (bearerToken, name, cursor, limit, langTag, members, open, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.createGroup = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.deleteGroup = function (bearerToken, groupId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.updateGroup = function (bearerToken, groupId, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (groupId === null || groupId === undefined) {
              throw new Error("'groupId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.addGroupUsers = function (bearerToken, groupId, userIds, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (groupId === null || groupId === undefined) {
              throw new Error("'groupId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.banGroupUsers = function (bearerToken, groupId, userIds, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (groupId === null || groupId === undefined) {
              throw new Error("'groupId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.demoteGroupUsers = function (bearerToken, groupId, userIds, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (groupId === null || groupId === undefined) {
              throw new Error("'groupId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.joinGroup = function (bearerToken, groupId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (groupId === null || groupId === undefined) {
              throw new Error("'groupId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.kickGroupUsers = function (bearerToken, groupId, userIds, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (groupId === null || groupId === undefined) {
              throw new Error("'groupId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.leaveGroup = function (bearerToken, groupId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (groupId === null || groupId === undefined) {
              throw new Error("'groupId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.promoteGroupUsers = function (bearerToken, groupId, userIds, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (groupId === null || groupId === undefined) {
              throw new Error("'groupId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listGroupUsers = function (bearerToken, groupId, limit, state, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (groupId === null || groupId === undefined) {
              throw new Error("'groupId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.validatePurchaseApple = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.validatePurchaseFacebookInstant = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.validatePurchaseGoogle = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.validatePurchaseHuawei = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listSubscriptions = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.validateSubscriptionApple = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.validateSubscriptionGoogle = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.getSubscription = function (bearerToken, productId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.deleteLeaderboardRecord = function (bearerToken, leaderboardId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.listLeaderboardRecords = function (bearerToken, leaderboardId, ownerIds, limit, cursor, expiry, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (leaderboardId === null || leaderboardId === undefined) {
              throw new Error("'leaderboardId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.writeLeaderboardRecord = function (bearerToken, leaderboardId, record, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (leaderboardId === null || leaderboardId === undefined) {
              throw new Error("'leaderboardId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listLeaderboardRecordsAroundOwner = function (bearerToken, leaderboardId, ownerId, limit, expiry, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (leaderboardId === null || leaderboardId === undefined) {
              throw new Error("'leaderboardId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listMatches = function (bearerToken, limit, authoritative, label, minSize, maxSize, query, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.getMatchmakerStats = function (bearerToken, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.deleteNotifications = function (bearerToken, ids, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.listNotifications = function (bearerToken, limit, cacheableCursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          var urlPath = "/v2/notification";
          var queryParams = new Map();
      ...
      LayerGApi.prototype.rpcFunc2 = function (bearerToken, basicAuthUsername, basicAuthPassword, id, payload, httpKey, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      /** Execute a Lua function on the server. */
      LayerGApi.prototype.rpcFunc = function (bearerToken, basicAuthUsername, basicAuthPassword, id, payload, httpKey, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (id === null || id === undefined) {
              throw new Error("'id' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.sessionLogout = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      /** Get storage objects. */
      LayerGApi.prototype.readStorageObjects = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.writeStorageObjects = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.deleteStorageObjects = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listStorageObjects = function (bearerToken, collection, userId, limit, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      /** List publicly readable storage objects in a given collection. */
      LayerGApi.prototype.listStorageObjects2 = function (bearerToken, collection, userId, limit, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (collection === null || collection === undefined) {
              throw new Error("'collection' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listTournaments = function (bearerToken, categoryStart, categoryEnd, startTime, endTime, limit, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.deleteTournamentRecord = function (bearerToken, tournamentId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      LayerGApi.prototype.listTournamentRecords = function (bearerToken, tournamentId, ownerIds, limit, cursor, expiry, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (tournamentId === null || tournamentId === undefined) {
              throw new Error("'tournamentId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.writeTournamentRecord2 = function (bearerToken, tournamentId, record, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (tournamentId === null || tournamentId === undefined) {
              throw new Error("'tournamentId' is a required parameter but is null or undefined.");
      ...
      /** Write a record to a tournament. */
      LayerGApi.prototype.writeTournamentRecord = function (bearerToken, tournamentId, record, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (tournamentId === null || tournamentId === undefined) {
              throw new Error("'tournamentId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.joinTournament = function (bearerToken, tournamentId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (tournamentId === null || tournamentId === undefined) {
              throw new Error("'tournamentId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.listTournamentRecordsAroundOwner = function (bearerToken, tournamentId, ownerId, limit, expiry, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (tournamentId === null || tournamentId === undefined) {
              throw new Error("'tournamentId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.getUsers = function (bearerToken, ids, usernames, facebookIds, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          var urlPath = "/v2/user";
          var queryParams = new Map();
      ...
      LayerGApi.prototype.listUserGroups = function (bearerToken, userId, limit, state, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (userId === null || userId === undefined) {
              throw new Error("'userId' is a required parameter but is null or undefined.");
      ...
      LayerGApi.prototype.buildFullUrl = function (basePath, fragment, queryParams) {
          var e_1, _a;
  ...
  var WebSocketAdapterText = /** @class */ (function () {
      ...
      WebSocketAdapterText.prototype.isOpen = function () {
          var _a;
          return !!this._socket && ((_a = this._socket) === null || _a === void 0 ? void 0 : _a.readyState) == WebSocket.OPEN;
      };
  ...
  /** A socket connection to LayerG server implemented with the DOM's WebSocket API. */
  ...
  var Client = /** @class */ (function () {
      function Client(serverkey, host, port, useSSL, timeout, autoRefreshSession) {
          ...
          this.apiClient = new LayerGApi(serverkey, basePath, timeout);
      }
      ...
      Client.prototype.authenticateTelegram = function (telegramId, telegramAppData, create, username, vars, options) {
          if (options === void 0) { options = {}; }
          var request = {
          ...
          return this.apiClient.authenticateTelegram("", "", request, create, options).then(function (apiSession) {
              return new Session(apiSession.token || "", apiSession.refresh_token || "", apiSession.created || false);
          });
      };
                  ...
                  switch (_a.label) {
                      case 0:
                          ...
                          if (session.created && session.expires_at - session.created_at < 70) {
                              console.warn("Session lifetime too short, please set '--session.token_expiry_sec' option");
                          }
                          if (session.created && session.refresh_expires_at - session.created_at < 3700) {
                              console.warn("Session refresh lifetime too short, please set '--session.refresh_token_expiry_sec' option");
                          }
